...
=======
```{r}
setwd("C:/Users/sarah/OneDrive/Documents/info201/project-group-28")
source("source/p02-coral-bleaching-map.R")
source("source/p02-coral-bargraph.R")
source("source/coral_bleaching_events_scatterplot.R")
```
