...
journals and social science journals such as The Washington Post, The New York Times, and The Economist."),
    ...
    h3("Discussion"),
    p("Our findings on coral bleaching around the world reveal the extent to which coral bleaching is currently affecting our oceans, and can give a general direction to which we can reverse its effects and make progress towards slowing the rate of coral bleaching. From our first dataset, we can make conclusions about where coral bleaching occurs most frequently, and focus on reversing its effects in those areas first. We found that coral bleaching can occur all around the world, which shows that factors affecting coral bleaching, such as changes in water temperature, light, and acidity, can affect locations throughout the world as well. Our data visualization also shows that coral bleaching also occurs in areas that tend to be more tropical or in locations with a higher density of islands, especially near the countries of Australia, Indonesia, the Philippines, Papua New Guinea, Fiji, and the Maldives. This not only reveals that these areas are at a higher risk of bleaching, but also shows that these areas are also more susceptible to the effects of climate change. It’s highly likely that the communities and economies of each region are affected by coral bleaching as well, and by understanding how coral reefs and their ecosystems affect the human populations surrounding them, we can also understand what consequences coral bleaching can have on them as well. The second dataset that we chose to focus on reveals not only when coral bleaching is more likely to occur, but also the oceans that are most highly affected by coral bleaching events. As mentioned previously, severe coral bleaching events can occur when a large percentage of coral in a reef all suffer from bleaching (generally above 30%). Severe coral bleaching events can have devastating effects on the surrounding ecosystems, and can negatively impact millions of species and organisms that depend on coral for food and shelter. Since 1930, hundreds of severe coral bleaching events have occurred around the world, and the frequency has only continued to increase since then. This not only helps us predict when and where coral bleaching can occur next, but also highlights how urgent and relevant of an issue it still is. Our findings from this data set also reveal patterns in climate change outside of coral bleaching. Based on when and where severe coral bleaching events occurred, we can also infer that during those periods, there were also more extreme changes in temperature and ocean acidification. These factors directly affect the populations and communities that live in the area, and reveal how severe patterns in climate change and global warming are during certain periods of time. Finally, the last dataset that we chose to analyze shows which coral species can be more susceptible to bleaching. Certain species of coral can be more resilient and aren’t as severely affected by changes in their environment. Different coral species can also have different reactions to various causing factors of bleaching. From our data, we found that coral bleaching affects the Acropora species most severely, despite it being one of the most common and widespread species of coral. We can infer that over time, the species that are more resistant to bleaching can end up becoming more common and populous, which changes the way coral reefs and their ecosystems operate. Since each species in a coral reef ecosystem interacts with coral differently, over time a change in the proportion of coral species can also change the state of coral reefs as a whole. By understanding where certain species of coral are more common, we can also infer how the surrounding environment can change depending on bleaching as well. Overall, coral bleaching not only negatively impacts coral reefs around the world, it also reveals patterns in climate change and global warming as well. Understanding when and where it occurs most commonly can also help us make progress towards preventing future instances of coral bleaching and reducing the effects of its causing factors."),
    h3("Conclusion"),
    p("As climate change and global warming continue to rise and affect the state of the globe, we must understand its effects and implications in order to make progress towards reversing its effects. One severe result of rising global ocean temperatures is coral bleaching, which occurs when coral lose their color and can suffer diseases and damages much more easily. Coral are organisms that provide shelter and food to a vast multitude of species in coral reefs, and are absolutely essential to the survival of these ecosystems. From a purely environmental standpoint, coral ensure the proper functioning and climate of tropical areas. Bleaching doesn’t necessarily kill coral, but causes them to become ghostly and lifeless. By losing their color and the nutrients within their tissues, coral become much more susceptible to mortality. This can also spread vastly across reefs, disrupting their ecosystems and the communities surrounding them as well.

As we know, coral bleaching is an ongoing problem that’s greatly affecting our global environment and our economy as well. This is because a quarter of marine species depend on coral reefs at some point in their lives, as do millions of people who depend on reefs for food, jobs, and shoreline protection from storm surges. Corals are essential to the marine animals thriving, which makes them also essential for our supply of fisheries. In addition, they support commercial and subsistence fisheries as well as jobs and businesses through tourism and recreation.

Although warming ocean temperatures is a prominent cause for coral bleaching, we wanted to understand about other conditions that make corals more vulnerable to bleaching. To find other factors that might contribute to coral bleaching, we made our focus on three different questions that consider where coral bleaching most commonly occurs, when do coral bleaching occur, and if more coral reefs can adapt to survive with resilient species. Stemming from these research questions, we were able to collect specific datas needed to create visualizations that answer our questions. Our visualizations revealed important information about what might have caused coral bleaching to increase in recent years and how we might be able to minimize the trend in the future. 

Our research has shown when and where coral bleaching occurs, but the next question is how do we fix it? Steps need to be taken to protect the coral reefs and to reverse the effects of coral bleaching. It starts with cutting down on carbon dioxide emissions of individuals and businesses. The process of reversing climate change will benefit the environment, and particularly the oceans. Reducing pollution will contribute to preventing ocean temperatures from rising, which will in turn prevent coral bleaching. The main insight we gained from our research is that the world and the way people live needs to change if we want coral reefs to continue to exist. 
"),
    h3("Acknowledgements"),
